...
# First part: for static images:
with mp_hands.Hands(
    static_image_mode=True,  # True = image, False = video input
    max_num_hands=4,
    min_detection_confidence=0.5) as hands:  # confidence?

    # Read an image, flip it around y-axis for correct handedness output (see
    # above).
    image = cv2.imread('IMG_7704.jpg')  # Insert your Image Here
    ...
    cv2.imwrite(r'IMG_7704.jpg', annotated_image)
